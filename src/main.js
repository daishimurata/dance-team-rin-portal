  ...
  const domatsuriSchedule = [
    ...
    },
    {
      ...
      items: [
        ...
        { time: '12:50', type: '演舞', name: '[1] 久屋大通公園会場 メインステージ', detail: 'ステージ演舞 ｜ 13:05 演舞後、南噴水広場に移動、おそらく記念撮影あり ｜ 13:20 解散、自由行動、各自で移動 ｜ 13:10 愛の広場集合、点呼 ｜ 13:20 栄駅に移動', mapQuery: '久屋大通公園メインステージ', spaceId: 1, dateNo: 4 },
        { time: '13:33', type: '電車', name: '栄駅 → 金山駅 → 道徳駅', detail: '【地下鉄名城線＋名鉄常滑線（金山乗換）】栄13:33発 → 金山13:47発(名鉄) → 13:53道徳駅着（地下鉄210円＋名鉄190円）/ 徒歩4分 ｜ 14:00 どえりゃ～どうとくパレード会場着、休憩 ｜ 14:20 集合(受付 14:33)' },
